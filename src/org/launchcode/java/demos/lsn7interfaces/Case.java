...
public class Case {
    ...
    public Case(){
        ...
        Topping topping1 = new Topping("Peanuts", 0.5, new ArrayList<>(Arrays.asList("nuts")));
        Topping topping2 = new Topping("Cherry Sauce", 0.5, new ArrayList<>(Arrays.asList("gelatin")));
        Topping topping3 = new Topping("Hot Fudge", 0.5, new ArrayList<>(Arrays.asList("gelatin")));
        Topping topping4 = new Topping("Bananas", 0.5, new ArrayList<>(Arrays.asList("dairy")));
